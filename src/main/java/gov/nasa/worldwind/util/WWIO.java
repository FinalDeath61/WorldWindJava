...
public class WWIO
{
    ...
    public static boolean saveBuffer(ByteBuffer buffer, File file, boolean forceFilesystemWrite) throws IOException
    {
        ...
        try
        {
            ...
            if (lock == null)
            {
                ...
                log.trace("WWIO.UnableToAcquireLockFor", file.getPath());
                return false;
            }
        ...
        {
            log.error(Logging.getMessage("WWIO.ErrorSavingBufferTo", file.getPath()), e);
    ...
    private static ByteBuffer transferStreamToByteBuffer(InputStream stream, int numBytes) throws IOException
    {
        ...
        if (numBytes < 1)
        {
            log.error("WWIO.NumberBytesTransferLessThanOne");
    ...
    public static boolean isFileOutOfDate(URL url, long expiryTime)
    {
        ...
        {
            log.error("WWIO.ExceptionValidatingFileExpiration", url);
            return false;
        }
    }
