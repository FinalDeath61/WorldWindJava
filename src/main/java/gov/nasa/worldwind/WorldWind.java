...
public final class WorldWind
{
    ...
    public static Object createComponent(String className) throws WWRuntimeException
    {
        ...
        {
            log.error("nullValue.ClassNameIsNull");
        ...
        {
            log.error("WorldWind.ExceptionCreatingComponent", className);
            throw new WWRuntimeException(Logging.getMessage("WorldWind.ExceptionCreatingComponent", className), e);
        }
        catch (Throwable t)
        {
            log.error("WorldWind.ErrorCreatingComponent", className);
        ...
        throws IllegalStateException, IllegalArgumentException
    {
        ...
        {
            log.error("nullValue.ClassNameKeyNullZero");
        ...
        if (name == null)
        {
            log.error("WorldWind.NoClassNameInConfigurationForKey", classNameKey);
        ...
        {
            log.error("WorldWind.UnableToCreateClassForConfigurationKey", name);
