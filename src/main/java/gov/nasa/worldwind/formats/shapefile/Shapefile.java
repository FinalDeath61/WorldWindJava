    ...
    protected void initializeFromFile(File file, AVList params) throws IOException {
        ...
        if (file.canRead() && file.canWrite()) {
            try {
                ...
                log.debug(Logging.getMessage("SHP.MemoryMappingEnabled", file.getPath()));
            } catch (IOException e) {
                log.warn(Logging.getMessage("SHP.ExceptionAttemptingToMemoryMap", file.getPath()), e);
            }
        }
...
//                return SHAPE_MULTI_PATCH;
    ...
    public void export(String mimeType, Object output) throws IOException, UnsupportedOperationException {
        ...
        try {
            ...
            log.error(getClass().getName(), "export", e);
