...
public class SessionState
{
    ...
    protected void saveViewState(WorldWindow worldWindow)
    {
        ...
        {
            log.error("Unable to save view state: " + view, e);
        }
    }
    ...
    protected void restoreViewState(WorldWindow worldWindow)
    {
        ...
        {
            log.error("Unable to restore view state: " + stateFile, e);
        }
    }
    ...
    protected void saveLayerListState(WorldWindow worldWindow)
    {
        ...
        {
            log.error("Unable to save layer list state: " + stateFile, e);
        }
    }
    ...
    protected void restoreLayerListState(WorldWindow worldWindow)
    {
        ...
        {
            log.error("Unable to restore layer list state: " + stateFile, e);
        }
    }
    ...
    protected void saveLayerState(Layer layer, File stateFile)
    {
        ...
        {
            log.error("Unable to save layer state: " + layer, e);
        }
    }
    ...
    protected Layer restoreLayerState(File stateFile)
    {
        try
        {
            ...
            if (fn == null)
            {
                log.warn("Invalid layer state filename: " + stateFile.getName());
                return null;
            }
        ...
        {
            log.error("Unable to restore layer state: " + stateFile, e);
            return null;
        }
    }
